...
def main():
    ...
    argustrack_path: pathlib.Path = here / ".." / "argustrack"
    argustrack_files: list[pathlib.Path] = list(argustrack_path.rglob("*.py"))

    LANGUAGES: list[str] = ["zh_CN"]
    argustrack_translate_path: pathlib.Path = argustrack_path / "translate"
    for lang in LANGUAGES:
        ts_path: pathlib.Path = argustrack_translate_path / f"{lang}.ts"
        ...
        qm_path: pathlib.Path = argustrack_translate_path / f"{lang}.qm"
        subprocess.check_call(
