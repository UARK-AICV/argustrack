...
from argustrack._automation import polygon_from_mask
...
class Canvas(QtWidgets.QWidget):
    ...
    def _get_ai_image_embedding(self) -> osam.types.ImageEmbedding:
        ...
        image: np.ndarray = argustrack.utils.img_qt_to_arr(img_qt=qimage)
    ...
    def closeEnough(self, p1, p2):
        ...
        return argustrack.utils.distance(p1 - p2) < (self.epsilon / self.scale)
    ...
    def intersectingEdges(self, point1, point2, points):
        ...
        for i in range(4):
            ...
            if 0 <= ua <= 1 and 0 <= ub <= 1:
                ...
                d = argustrack.utils.distance(m - QPointF(x2, y2))
                yield d, i, (x, y)
