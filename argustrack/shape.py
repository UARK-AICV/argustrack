...
class Shape:
    ...
    def paint(self, painter):
        ...
        if self.mask is not None:
            ...
            qimage = QtGui.QImage.fromData(argustrack.utils.img_arr_to_data(image_to_draw))
        ...
        if self.points:
            ...
            if self.shape_type in ["rectangle", "mask"]:
                ...
                assert len(self.points) in [1, 2]
                if len(self.points) == 2:
                    raidus = argustrack.utils.distance(
    ...
    def nearestVertex(self, point, epsilon):
        ...
        for i, p in enumerate(self.points):
            ...
            dist = argustrack.utils.distance(p - point)
    ...
    def nearestEdge(self, point, epsilon):
        ...
        for i in range(len(self.points)):
            ...
            line = [start, end]
            dist = argustrack.utils.distancetoline(point, line)
            if dist <= epsilon and dist < min_distance:
                min_distance = dist
                post_i = i
        return post_i
    ...
    def makePath(self):
        if self.shape_type in ["rectangle", "mask"]:
            ...
            path = QtGui.QPainterPath()
            if len(self.points) == 2:
                raidus = argustrack.utils.distance(self.points[0] - self.points[1])
